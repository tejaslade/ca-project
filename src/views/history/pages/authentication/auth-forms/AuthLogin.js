...
const FirebaseLogin = ({ ...others }) => {
  ...
  useEffect(() => {
    ...
    try {
      axios
        .get(
          `https://b2e1-203-192-225-77.in.ngrok.io/api/auth/google/callback?${search}`
        )
        .then((response) => {
          console.log("helo");
  ...
  return (
    <>
        ...
        <Grid item xs={12}>
          <AnimateButton>
            <Button
              ...
              onClick={() =>
                (window.location =
                  "https://b2e1-203-192-225-77.in.ngrok.io/api/connect/google")
              }
              size="large"
              variant="outlined"
              sx={{
      ...
      <Formik
        initialValues={{
          email: "tejaslade89@gmail.com",
          password: "$Tejaslade89$",
          submit: null,
        }}
